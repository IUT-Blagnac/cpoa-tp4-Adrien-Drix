...
import action.ApplicationContextAgenceBancaire;
...
public class ActionAjouterCompte<E> implements Action<E>{
	...
	public void execute(E e) throws Exception {
		...
		// ApplicationContextAgenceBancaire dataContext = new ApplicationContextAgenceBancaire();
		// dataContext.getInstance().addCompte(c);
